...
export default function Workshop() {
    ...
    <>
      ...
      >
        <div className="flex flex-col justify-items-center items-center gap-2">
          ...
          <div className="relative w-[100vw] h-[477px] border-black p-4 mx-auto">
  {/* Top-left rectangle */}
  <div className="absolute top-[5%] left-[25%] w-[20%] md:w-[228px] h-1/2 md:h-[287px] bg-[#D9D9D9] border-4 border-black rounded-lg shadow-md"></div>

  {/* Top-right text */}
  <div className="absolute top-[5%] right-[25%] w-[25%] text-right text-black text-sm md:text-base font-itim">
  ...
  {/* Center rectangle */}
  <div className="absolute top-1/2 left-1/2 w-[20%] md:w-[228px] h-[50%] md:h-[287px] bg-[#D9D9D9] border-4 border-black rounded-lg shadow-md transform -translate-x-1/2 -translate-y-1/2"></div>

  {/* Bottom-left text */}
  <div className="absolute bottom-[5%] left-[25%] w-[25%] text-left text-black text-sm md:text-base">
    <p className="text-lg md:text-3xl">
      Equip yourself with the skills to shape the future
    </p>
  </div>
  ...
  <div className="absolute bottom-[2%] right-[25%] w-[20%] md:w-[228px] h-1/2 md:h-[287px] bg-[#D9D9D9] border-4 border-black rounded-lg shadow-md"></div>
</div>
          ...
          {data.map((item, index) => (
            <div
              key={index}
              className="max-w-full md:max-w-[1178px] border-black p-4 mx-auto"
            >
              <div className="flex flex-col md:flex-row gap-10">
                <div className="flex flex-col items-start gap-4">
                  <p className="text-3xl md:text-4xl">{item.topic}</p>
                  <div className="w-[40%] h-[35vh] md:w-[282px] md:h-[322px] bg-[#D9D9D9] border-4 border-black rounded-lg shadow-md"></div>
                </div>

                <div className="flex flex-col flex-grow pt-12">
                  <div className="flex flex-row items-center gap-4">
                    <div className="w-[90px] md:w-[130px] h-[90px] md:h-[130px] bg-[#D9D9D9] border-4 border-black rounded-lg shadow-md"></div>
                    ...
                    <div className="flex flex-row w-full md:w-[78%] justify-between px-4 md:pl-[3%] md:pr-[10%]">
                      ...
                      <div className="flex flex-col items-end">
                        <span className="text-lg md:text-2xl">{item.registration}</span>
                        <span className="text-lg md:text-2xl">Fee - {item.price}</span>
                        <button className="w-[94px] h-[30px] border-2 border-black rounded-lg bg-green-300">
