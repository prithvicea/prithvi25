        ...
        {workshops.map((workshop, index) => (
          ...
          >
            ...
            >
              ...
              {/* View Button */}
              <button className="absolute bottom-3 right-3 px-4 md:px-5 py-1 md:py-0.5 border border-white text-white rounded-full text-sm bg-black hover:bg-white hover:text-black transition-all duration-300">
                View
              </button>
            </div>
          </SplideSlide>
